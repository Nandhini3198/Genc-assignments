...
public class Trainings {
	...
	public Trainings(long id, String user_id, String mentor_id, String skill_id, String status, int progress,
			int rating, String start_date, String end_date, String start_time, String end_time,
